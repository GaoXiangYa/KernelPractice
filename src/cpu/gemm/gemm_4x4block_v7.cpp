...
static void addDot4x4(int k, float *A, int lda, float *B, int ldb, float *C,
  ...
  for (int p = 0; p < k; ++p) {
    a0_reg = A(0, p);
    c0_reg_0 += a0_reg * *bp0_ptr;
    c0_reg_1 += a0_reg * *bp1_ptr;
    c0_reg_2 += a0_reg * *bp2_ptr;
    c0_reg_3 += a0_reg * *bp3_ptr;

    a1_reg = A(1, p);
    c1_reg_0 += a1_reg * *bp0_ptr;
    c1_reg_1 += a1_reg * *bp1_ptr;
    c1_reg_2 += a1_reg * *bp2_ptr;
    c1_reg_3 += a1_reg * *bp3_ptr;

    a2_reg = A(2, p);
    c2_reg_0 += a2_reg * *bp0_ptr;
    c2_reg_1 += a2_reg * *bp1_ptr;
    c2_reg_2 += a2_reg * *bp2_ptr;
    c2_reg_3 += a2_reg * *bp3_ptr;

    a3_reg = A(3, p);
    c3_reg_0 += a3_reg * *bp0_ptr;
    c3_reg_1 += a3_reg * *bp1_ptr;
    c3_reg_2 += a3_reg * *bp2_ptr;
    c3_reg_3 += a3_reg * *bp3_ptr;
